...
async def create_chat_session(request: Request) -> Response:
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            ...
            session = await ChatCRUD.create_session(
                db, 
...
async def get_session(request: Request) -> Response:
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            session = await ChatCRUD.get_session(db, session_id)
            return ApiResponse.success(data=session.to_dict())
    except Exception as e:
        return ApiResponse.error(message=str(e))
...
async def get_sessions(request: Request) -> Response:
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            sessions = await ChatCRUD.list_sessions(db, user_id, page, page_size)
...
async def delete_session(request: Request) -> Response:
    ...
    try:
        session_id = request.path_params.get("session_id")
        async with AsyncSessionLocal() as db:
            session = await ChatCRUD.soft_delete_session(db, session_id)
...
async def update_session_title(request: Request) -> Response:
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            session = await ChatCRUD.update_session_title(db, session_id, new_title)
...
async def create_chat_message(request: Request) -> Response:
    ...
    try:
        data = request.json()
        async with AsyncSessionLocal() as db:
            message = await ChatCRUD.create_message(
                db,
...
async def get_message(request: Request) -> Response:
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            message = await ChatCRUD.get_message(db, session_id, message_id)
            return ApiResponse.success(data=message.to_dict())
    except Exception as e:
        return ApiResponse.error(message=str(e))
...
async def get_messages(request: Request) -> Response:
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            messages = await ChatCRUD.list_messages(db, session_id, page, page_size)
...
async def delete_message(request: Request) -> Response:
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            message = await ChatCRUD.soft_delete_message(db, message_id)
...
async def update_message_content(request: Request) -> Response:
    ...
    try:
        ...
        async with AsyncSessionLocal() as db:
            message = await ChatCRUD.update_message_content(db, message_id, new_content)
