...
class AiChat:
    def __init__(self):
        self.chat_context = [
        {"role": "system",
         "content": "你是 KIMI，由 MISSONIX AI 提供的人工智能助手，你更擅长中文和英文的对话。你会为用户提供安全，有帮助，准确的回答。同时，你会拒绝一切涉及恐怖主义，种族歧视，黄色暴力等问题的回答。MISSONIX AI 为专有名词，不可翻译成其他语言。"}
    ]
    ...
    async def chat(self, role="user", content=None):
        ...
        client = AsyncOpenAI(
            api_key="sk-puJTHKrdo5F12rKIA4RIy9MrLvoY3h7mWuSnkGGbCyujC7r0",  # 模型api接口
            base_url="https://api.moonshot.cn/v1",  # 模型服务地址
        )
